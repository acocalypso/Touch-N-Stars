    ...
    <template #body>
      <div class="grid w-full gap-6">
        <section class="grid gap-2">
          <h4 class="atlas-settings-heading">
            {{ $t('components.celestiaAtlas.settings.section_display') }}
          </h4>
        ...
        <section class="grid gap-2">
          <h4 class="atlas-settings-heading">
            {{ $t('components.celestiaAtlas.settings.section_landscape') }}
          </h4>
          <div :class="settingsContainerClasses">
            <div
              class="flex flex-row items-center justify-between w-full border border-gray-500 p-2 rounded-lg"
        ...
        <section class="grid gap-2">
          <h4 class="atlas-settings-heading">
            {{ $t('components.celestiaAtlas.settings.section_survey') }}
          </h4>
          <div :class="settingsContainerClasses">
            <div
              ...
              <template v-else>
                ...
                <template v-else>
                  ...
                  <div
                    ...
                    class="grid gap-2 border-t border-gray-600 pt-3"
                  >
        ...
        <section class="grid gap-2">
          <h4 class="atlas-settings-heading">
            {{ $t('components.celestiaAtlas.settings.section_catalogs') }}
          </h4>
          <div :class="settingsContainerClasses">
            <div
              class="flex flex-row items-center justify-between w-full border border-gray-500 p-2 rounded-lg"
        ...
        <section class="grid gap-2">
          <h4 class="atlas-settings-heading">
            {{ $t('components.celestiaAtlas.settings.section_about') }}
          </h4>
          <CelestiaAtlasAbout />
        </section>
      </div>
