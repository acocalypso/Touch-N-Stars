<template>
  <NumberInputPicker
    v-if="minMove !== null"
    v-model="minMove"
    :label="$t('components.guider.phd2.dec.MinMove')"
    labelKey="components.guider.phd2.dec.MinMove"
    :help-message="$t('components.guider.phd2.help.algo.minMove')"
    :min="0"
    :max="1"
    :step="0.01"
    :decimalPlaces="2"
    inputId="min-move-dec"
  ...
  <NumberInputPicker
    v-if="maxMove !== null"
    v-model="maxMove"
    :label="$t('components.guider.phd2.dec.MaxMove')"
    labelKey="components.guider.phd2.dec.MaxMove"
    :help-message="$t('components.guider.phd2.help.algo.maxMove')"
    :min="0"
    :max="10"
    :step="0.01"
    :decimalPlaces="2"
    inputId="max-move-dec"
  ...
  <NumberInputPicker
    ...
    :help-message="$t('components.guider.phd2.help.algo.aggression')"
    :min="0"
    :max="100"
    :step="1"
    :decimalPlaces="0"
  ...
  <NumberInputPicker
    ...
    :help-message="$t('components.guider.phd2.help.algo.hysteresis')"
    :min="0"
    :max="100"
    :step="1"
    :decimalPlaces="0"
  ...
  <NumberInputPicker
    ...
    :help-message="$t('components.guider.phd2.help.algo.predictiveWeight')"
    :min="0"
    :max="100"
    :step="1"
    :decimalPlaces="0"
  ...
  <NumberInputPicker
    ...
    :help-message="$t('components.guider.phd2.help.algo.reactiveWeight')"
    :min="0"
    :max="100"
    :step="1"
    :decimalPlaces="0"
  ...
  <NumberInputPicker
    ...
    v-model="slopeWeight"
    :label="$t('components.guider.phd2.dec.slope_weight')"
    labelKey="components.guider.phd2.dec.slope_weight"
    :help-message="$t('components.guider.phd2.help.algo.slopeWeight')"
    :min="0"
    :max="1"
    :step="0.01"
    :decimalPlaces="2"
    inputId="slope-weight-dec"
    @change="debouncedUpdateSlopeWeight"
  />
  <NumberInputPicker
    v-if="expFactor !== null"
    v-model="expFactor"
    :label="$t('components.guider.phd2.dec.exp_factor')"
    labelKey="components.guider.phd2.dec.exp_factor"
    :help-message="$t('components.guider.phd2.help.algo.expFactor')"
    :min="0"
    :max="5"
    :step="0.1"
    :decimalPlaces="1"
    inputId="exp-factor-dec"
