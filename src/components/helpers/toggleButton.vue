<template>
  <div class="flex items-center">
    <button
      @click="updateToggled"
      :class="[
        statusValue ? 'bg-emerald-600/20 border-emerald-500/60' : 'bg-slate-700/40 border-slate-600/40',
    ...
    >
      ...
      <span
        :class="[
          statusValue ? 'translate-x-6 bg-gradient-to-br from-emerald-400 to-emerald-600 shadow-emerald-400/40' : 'translate-x-1 bg-gradient-to-br from-slate-300 to-slate-400 shadow-slate-400/30',
      ...
      >
        ...
        <div 
          :class="[
            statusValue ? 'bg-gradient-to-br from-emerald-200/60 to-transparent' : 'bg-gradient-to-br from-white/60 to-transparent',
