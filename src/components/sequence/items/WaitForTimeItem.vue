  ...
  <ItemShell :item="item">
    ...
    <template #editor="{ save }">
      ...
      <div class="grid grid-cols-3 gap-1">
        <NumberInputPicker :modelValue="item.Hours" label="h" labelKey="waittime-h"
          :min="0" :max="23" :step="1" labelPosition="top" wrapperClass="w-full"
          @change="save('Hours', $event)" />
        <NumberInputPicker :modelValue="item.Minutes" label="m" labelKey="waittime-m"
          :min="0" :max="59" :step="1" labelPosition="top" wrapperClass="w-full"
          @change="save('Minutes', $event)" />
        <NumberInputPicker :modelValue="item.Seconds" label="s" labelKey="waittime-s"
          :min="0" :max="59" :step="1" labelPosition="top" wrapperClass="w-full"
