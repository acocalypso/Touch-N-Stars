<template>
  <div
    class="absolute bottom-4 left-1/2 transform -translate-x-1/2 bg-black bg-opacity-80 p-2 rounded-lg text-gray-200 font-mono"
  >
    <div class=" text-center">{{ formattedTime }}</div>
    <div class="text-xs text-center">{{ formattedDate }}</div>
  </div>
</template>
