      ...
      <div class="space-y-4">
        ...
        <section>
          ...
          <ul class="list-disc pl-5 space-y-1 text-sm">
            ...
            <li>The red component has been built from POSS-II F, AAO-SES,SR and SERC-ER plates.</li>
            ...
            <li>
              Three missing plates from red survey (253, 260, 359) has been replaced by pixels from
              the DSSColor STScI jpeg survey.
            </li>
            <li>
              The 11 missing blue plates (mainly in galactic plane) have not been replaced (only red
              component).
            </li>
          </ul>
        ...
        <section>
          ...
          <p class="text-sm mb-2">
            High-resolution planet textures from Stellarium Labs under Creative Commons Attribution
          ...
          <p class="text-sm text-gray-400 mt-1">Texture processing by Oleg Pluton (Helleformer)</p>
        </section>
