...
import FilterOffsetView from './views/FilterOffsetCalculator.vue';
import { usePluginStore } from '@/store/pluginStore';
import metadata from './plugin.json';
import FilterOffsetIcon from './components/FilterOffsetIcon.vue';
