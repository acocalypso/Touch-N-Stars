<template>
  <div
    class="absolute top-3 left-(--nav-offset) bg-gradient-to-br from-gray-800/80 to-gray-900/90 backdrop-blur-lg px-3 py-2 text-white flex items-center gap-1.5 rounded-lg border border-gray-700/50 z-50 shadow-lg shadow-black/40 transition-all duration-300 portrait:hidden"
  >
