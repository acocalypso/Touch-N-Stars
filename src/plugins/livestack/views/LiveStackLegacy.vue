...
import { useLivestackStoreLegacy } from '../store/livestackStoreLegacy';
...
import TargetFilterSelector from '../components/TargetFilterSelectorLegacy.vue';

const { t } = useI18n();
const livestackStore = useLivestackStoreLegacy();
