<template>
  <div class="container py-16 flex items-center justify-center">
    <div class="container max-w-4xl">
      <h5 class="text-2xl text-center font-bold text-white mb-4">{{ $t('plugins.telescopius.title') }}</h5>
      ...
      <div class="flex flex-col space-y-4">
        ...
        >
          ...
          <!-- API Key Status -->
          <div v-if="telescopiusStore.hasApiKey" class="mt-4 p-3 bg-green-900/30 border border-green-600 rounded-lg">
