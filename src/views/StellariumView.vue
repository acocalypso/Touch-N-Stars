  ...
  <div class="stellarium-container" :class="containerClasses">
    ...
    >
      ...
      <button
        ...
        class="p-2 bg-gray-700 hover:bg-gray-600 text-white rounded-full border border-gray-600 hover:border-gray-500 transition-colors"
        title="Refresh Stellarium (fix touch issues)"
      >
